                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-5 col-sm-6 col-lg-4 mt-4">
                            <a href="{{route("update.task",[$item->id])}}" class="btn btn-primary w-100">Actualizar</a>
                        </div>
                        <div class="col-12 col-md-4 col-sm-6 col-lg-4 mt-4">
                            <button class="btn btn-danger w-100" onclick="eliminar({{$item->id}})" data-id="{{$item->id}}">Eliminar</button>
                        </div>
                    </div>
